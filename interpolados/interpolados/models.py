...
class CcMontos(models.Model):
    gid = models.AutoField(primary_key=True)
    site_name = models.CharField(max_length=254, blank=True, null=True)
    site_addre = models.CharField(max_length=254, blank=True, null=True)
    ...
    enlace = models.CharField(max_length=254, blank=True, null=True)
    monto = models.CharField(max_length=254, blank=True, null=True)
    plazo = models.FloatField(blank=True, null=True)
    nodo = models.CharField(max_length=254, blank=True, null=True)
